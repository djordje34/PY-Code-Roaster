...
enum DebuggerOptions_DebuggerType : int {
  DebuggerOptions_DebuggerType_DEBUGGER_TYPE_UNSPECIFIED = 0,
  DebuggerOptions_DebuggerType_DEBUGGER_TYPE_WHOLE_MODEL = 1,
  DebuggerOptions_DebuggerType_DEBUGGER_TYPE_PER_LAYER = 2,
  DebuggerOptions_DebuggerType_DebuggerOptions_DebuggerType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  DebuggerOptions_DebuggerType_DebuggerOptions_DebuggerType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
bool DebuggerOptions_DebuggerType_IsValid(int value);
constexpr DebuggerOptions_DebuggerType DebuggerOptions_DebuggerType_DebuggerType_MIN = DebuggerOptions_DebuggerType_DEBUGGER_TYPE_UNSPECIFIED;
constexpr DebuggerOptions_DebuggerType DebuggerOptions_DebuggerType_DebuggerType_MAX = DebuggerOptions_DebuggerType_DEBUGGER_TYPE_PER_LAYER;
constexpr int DebuggerOptions_DebuggerType_DebuggerType_ARRAYSIZE = DebuggerOptions_DebuggerType_DebuggerType_MAX + 1;

const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* DebuggerOptions_DebuggerType_descriptor();
template<typename T>
inline const std::string& DebuggerOptions_DebuggerType_Name(T enum_t_value) {
  static_assert(::std::is_same<T, DebuggerOptions_DebuggerType>::value ||
    ::std::is_integral<T>::value,
    "Incorrect type passed to function DebuggerOptions_DebuggerType_Name.");
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(
    DebuggerOptions_DebuggerType_descriptor(), enum_t_value);
}
inline bool DebuggerOptions_DebuggerType_Parse(
    ::PROTOBUF_NAMESPACE_ID::ConstStringParam name, DebuggerOptions_DebuggerType* value) {
  return ::PROTOBUF_NAMESPACE_ID::internal::ParseNamedEnum<DebuggerOptions_DebuggerType>(
    DebuggerOptions_DebuggerType_descriptor(), name, value);
}
enum OpSet : int {
...
class DebuggerOptions final :
 ...
 public:
  ...
  typedef DebuggerOptions_DebuggerType DebuggerType;
  static constexpr DebuggerType DEBUGGER_TYPE_UNSPECIFIED =
    DebuggerOptions_DebuggerType_DEBUGGER_TYPE_UNSPECIFIED;
  static constexpr DebuggerType DEBUGGER_TYPE_WHOLE_MODEL =
    DebuggerOptions_DebuggerType_DEBUGGER_TYPE_WHOLE_MODEL;
  static constexpr DebuggerType DEBUGGER_TYPE_PER_LAYER =
    DebuggerOptions_DebuggerType_DEBUGGER_TYPE_PER_LAYER;
  static inline bool DebuggerType_IsValid(int value) {
    return DebuggerOptions_DebuggerType_IsValid(value);
  }
  static constexpr DebuggerType DebuggerType_MIN =
    DebuggerOptions_DebuggerType_DebuggerType_MIN;
  static constexpr DebuggerType DebuggerType_MAX =
    DebuggerOptions_DebuggerType_DebuggerType_MAX;
  static constexpr int DebuggerType_ARRAYSIZE =
    DebuggerOptions_DebuggerType_DebuggerType_ARRAYSIZE;
  static inline const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor*
  DebuggerType_descriptor() {
    return DebuggerOptions_DebuggerType_descriptor();
  }
  template<typename T>
  static inline const std::string& DebuggerType_Name(T enum_t_value) {
    ...
    return DebuggerOptions_DebuggerType_Name(enum_t_value);
  }
  static inline bool DebuggerType_Parse(::PROTOBUF_NAMESPACE_ID::ConstStringParam name,
      DebuggerType* value) {
    return DebuggerOptions_DebuggerType_Parse(name, value);
  }
  ...
  // .tensorflow.quantization.DebuggerOptions.DebuggerType debugger_type = 1;
  void clear_debugger_type();
  ::tensorflow::quantization::DebuggerOptions_DebuggerType debugger_type() const;
  void set_debugger_type(::tensorflow::quantization::DebuggerOptions_DebuggerType value);
  private:
  ::tensorflow::quantization::DebuggerOptions_DebuggerType _internal_debugger_type() const;
  void _internal_set_debugger_type(::tensorflow::quantization::DebuggerOptions_DebuggerType value);
  public:
...
inline ::tensorflow::quantization::DebuggerOptions_DebuggerType DebuggerOptions::_internal_debugger_type() const {
  return static_cast< ::tensorflow::quantization::DebuggerOptions_DebuggerType >(_impl_.debugger_type_);
}
inline ::tensorflow::quantization::DebuggerOptions_DebuggerType DebuggerOptions::debugger_type() const {
  // @@protoc_insertion_point(field_get:tensorflow.quantization.DebuggerOptions.debugger_type)
  return _internal_debugger_type();
}
inline void DebuggerOptions::_internal_set_debugger_type(::tensorflow::quantization::DebuggerOptions_DebuggerType value) {
  
  _impl_.debugger_type_ = value;
}
inline void DebuggerOptions::set_debugger_type(::tensorflow::quantization::DebuggerOptions_DebuggerType value) {
...
template <> struct is_proto_enum< ::tensorflow::quantization::DebuggerOptions_DebuggerType> : ::std::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::tensorflow::quantization::DebuggerOptions_DebuggerType>() {
  return ::tensorflow::quantization::DebuggerOptions_DebuggerType_descriptor();
}
